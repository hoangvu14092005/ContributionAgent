...
1. **Create a [GitHub Issue](https://github.com/chinhkrb113/ContribAI/issues/new)** with the `security` label
2. For critical vulnerabilities, use [GitHub Security Advisories](https://github.com/chinhkrb113/ContribAI/security/advisories) instead
3. Include:
