...
| **Custom LLM** | |
| [`CUSTOM_LLM_SETUP.md`](docs/CUSTOM_LLM_SETUP.md) | Setup guide for self-hosted LLM endpoints |
| [`GIT_PULL_CUSTOM_LLM.md`](docs/GIT_PULL_CUSTOM_LLM.md) | How to pull updates while keeping custom LLM config |
| [`CUSTOM_LLM_QUICK_REF.md`](docs/CUSTOM_LLM_QUICK_REF.md) | Quick reference card for custom LLM |
| [`CUSTOM_LLM_CHANGES.md`](CUSTOM_LLM_CHANGES.md) | Technical details of custom LLM implementation |
