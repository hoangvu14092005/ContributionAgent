...
- **[Custom LLM Setup](./CUSTOM_LLM_SETUP.md)** — Complete guide for self-hosted LLM endpoints
- **[Git Pull with Custom LLM](./GIT_PULL_CUSTOM_LLM.md)** — How to maintain custom config when pulling updates
- **[Custom LLM Quick Reference](./CUSTOM_LLM_QUICK_REF.md)** — Cheat sheet for custom LLM
- **[Custom LLM Changes](../CUSTOM_LLM_CHANGES.md)** — Technical implementation details
...
- **Report Issues:** [GitHub Issues](https://github.com/chinhkrb113/ContribAI/issues)
- **Discuss Ideas:** [GitHub Discussions](https://github.com/chinhkrb113/ContribAI/discussions)
